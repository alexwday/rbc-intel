"""Tests for PDF processor vision pipeline."""
...
@patch("ingestion.processors.pdf.processor.fitz")
...
@patch(
    "ingestion.processors.pdf.processor.get_pdf_vision_max_retries",
    return_value=0,
)
...
@patch(
    "ingestion.processors.pdf.processor.shrink_image",
...
@patch(
    "ingestion.processors.pdf.processor.split_image",
