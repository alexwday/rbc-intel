...
from .config import get_dense_table_description_max_prompt_tokens
from .content_chunker import count_tokens
from .content_types import DenseTableDescription
...
def estimate_dense_description_tokens(
    ...
    prompt = load_prompt("dense_table_description")
...
def _merge_batched_dense_description(
    ...
    prompt = load_prompt("dense_table_description_merge")
